...
@Component({
  selector: 'app-xmdcaigoudetimport',
  templateUrl: './xmdcaigoudetimport.component.html',
  styleUrls: ['./xmdcaigoudetimport.component.scss']
})
export class XmdCaigoudetimportComponent implements OnInit {
  // 品名选择弹窗
  ...
  constructor(public bsModalRef: BsModalRef, public settings: SettingsService,
              private toast: ToasterService, private caigouApi: XmdCaigouService,
