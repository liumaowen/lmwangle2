...
@Component({
  selector: 'app-xmdruku',
  templateUrl: './xmdruku.component.html',
  styleUrls: ['./xmdruku.component.scss']
})
export class XmdrukuComponent implements OnInit {
  ...
  constructor(private rukuapi: XmdrukuService, private datepipe: DatePipe, private toast: ToasterService,private storage: StorageService) {
    this.querydata();
  }
