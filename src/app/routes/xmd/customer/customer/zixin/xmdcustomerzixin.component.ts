...
@Component({
  selector: 'app-xmdcustomerzixin',
  templateUrl: './xmdcustomerzixin.component.html',
  styleUrls: ['./xmdcustomerzixin.component.scss']
})
export class XmdcustomerzixinComponent implements OnInit {
