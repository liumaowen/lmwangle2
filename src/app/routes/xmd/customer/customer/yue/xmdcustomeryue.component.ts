...
@Component({
  selector: 'app-xmdcustomeryue',
  templateUrl: './xmdcustomeryue.component.html',
  styleUrls: ['./xmdcustomeryue.component.scss']
})
export class XmdCustomeryueComponent implements OnInit {
