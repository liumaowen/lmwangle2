...
@Component({
  selector: 'app-xmdcustomermailaddress',
  templateUrl: './xmdcustomermailaddress.component.html',
  styleUrls: ['./xmdcustomermailaddress.component.scss']
})
export class XmdcustomermailaddressComponent implements OnInit {
