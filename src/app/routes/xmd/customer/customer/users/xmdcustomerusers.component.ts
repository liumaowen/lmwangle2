...
@Component({
  selector: 'app-xmdcustomerusers',
  templateUrl: './xmdcustomerusers.component.html',
  styleUrls: ['./xmdcustomerusers.component.scss']
})
export class XmdCustomerusersComponent implements OnInit {
