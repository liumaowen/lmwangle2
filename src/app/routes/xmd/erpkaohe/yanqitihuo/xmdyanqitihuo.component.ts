...
@Component({
  selector: 'app-xmdyanqitihuo',
  templateUrl: './xmdyanqitihuo.component.html',
  styleUrls: ['./xmdyanqitihuo.component.scss']
})
export class XmdyanqitihuoComponent implements OnInit {
  search: any = {};
  buyer = [];
  orgs = [];
  saleman;
  ...
  constructor(public settings: SettingsService, private erpkaoheapi: XmderpkaoheService, private datepipe: DatePipe,
