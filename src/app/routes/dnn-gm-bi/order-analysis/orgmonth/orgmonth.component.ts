...
@Component({
    selector: 'app-orgmonth',
    templateUrl: './orgmonth.component.html',
    styleUrls: ['./orgmonth.component.scss']
})
export class OrgmonthComponent implements OnInit {
    ...
    constructor(public settings: SettingsService, private gmbiApi: GmbiService, private datepipe: DatePipe, private numpipe: DecimalPipe) {
        ...
        this.gridOptions.columnDefs = [
            ...
            { headerName: '机构', field: 'orgname', minWidth: 150, cellRenderer: 'group', showRowGroup: 'orgname', rowGroup: true },
            { cellClass: 'text-center', headerName: '鼓励类', field: 'urge', minWidth: 60 },
...

            {
                ...
                children: [
                    ...
                    { cellStyle: { "text-align": "right" }, headerName: '实提减退货', field: 'hjshiti', minWidth: 70, aggFunc: 'sum', valueGetter: (params) => params.data['olshiti'] + params.data['oflagentshiti'] + params.data['oflselfshiti'] - params.data['tuihuo'], valueFormatter: this.settings.valueFormatter3 }
                ]
            },
    ...
    querylist() {
        ...
        this.gmbiApi.getOforgmonth(search).then(data => {
