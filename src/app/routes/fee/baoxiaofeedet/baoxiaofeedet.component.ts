...
@Component({
  selector: 'app-baoxiaofeedet',
  templateUrl: './baoxiaofeedet.component.html',
  styleUrls: ['./baoxiaofeedet.component.scss']
})
export class BaoxiaofeedetComponent implements OnInit {
  ...
  constructor(public settings: SettingsService,
    ...
    this.gridOptions.columnDefs = [
      ...
      {
        cellStyle: { 'text-align': 'center' }, headerName: '分摊人', field: 'allocationusername', width: 70
      },
      {
  ...
  listDetail() {
    this.feeApi.baoxiaofeedet(this.requestparams).then((response) => {
