...
@Component({
  ...
  templateUrl: './adjfeehuizong.component.html',
  styleUrls: ['./adjfeehuizong.component.scss']
})
export class AdjfeehuizongComponent implements OnInit {
