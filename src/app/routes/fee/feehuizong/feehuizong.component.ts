...
@Component({
  selector: 'app-feehuizong',
  templateUrl: './feehuizong.component.html',
  styleUrls: ['./feehuizong.component.scss']
})
export class FeehuizongComponent implements OnInit {
  ...
  constructor(public settings: SettingsService,
    ...
    this.gridOptions.columnDefs = [
      ...
      { cellStyle: { 'text-align': 'center' }, headerName: '能否批量处理', field: 'ispiliangchuli', minWidth: 70 },
      {
      ...
      { cellStyle: { 'text-align': 'center' }, headerName: '单子总重量', field: 'billtweight', minWidth: 75 }
    ];
    this.getMyRole();
  ...
  listDetail() {
    this.feeApi.feehuizong(this.requestparams).then((response) => {
