...
@Component({
  selector: 'app-customermoney',
  templateUrl: './customermoney.component.html',
  styleUrls: ['./customermoney.component.scss']
})
export class CustomermoneyComponent implements OnInit {
