...
@Component({
  selector: 'app-mycustomeraddress',
  templateUrl: './mycustomeraddress.component.html',
  styleUrls: ['./mycustomeraddress.component.scss']
})
export class MycustomeraddressComponent implements OnInit {
  ...
  // 查询时序表数据
  querydata() {
    this.mycustomerApi.getAddress(this.route.parent.params['value']['id']).then(data => {
      // 获取到总条目
