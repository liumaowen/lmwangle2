...
@Component({
  selector: 'app-tiaohuofanxi',
  templateUrl: './tiaohuofanxi.component.html',
  styleUrls: ['./tiaohuofanxi.component.scss']
})
export class TiaohuofanxiComponent implements OnInit {
  search: any = {};
  ...
  listDetail() {
    // 从服务器获取数据赋值给网格
    this.tiaohuoApi.dingjinfanxi(this.search).then((data) => {
