...
@Component({
  selector: 'app-orderdetcxreport',
  templateUrl: './orderdetcxreport.component.html',
  styleUrls: ['./orderdetcxreport.component.scss']
})
export class OrderdetcxreportComponent implements OnInit {
  ...
  listDetail() {
    ...
    this.reportApi.orderdetcx(this.requestparams).then((response) => {
