...
@Component({
  selector: 'app-overdraftdetreport',
  templateUrl: './overdraftdetreport.component.html',
  styleUrls: ['./overdraftdetreport.component.scss']
})
export class OverdraftdetreportComponent implements OnInit {
  ...
  constructor(public settings: SettingsService,
    ...
    private OverdraftdetreportApi: OverdraftdetreportService) {
