...
@Component({
  selector: 'app-tihuodetcxreport',
  templateUrl: './tihuodetcxreport.component.html',
  styleUrls: ['./tihuodetcxreport.component.scss']
})
export class TihuodetcxreportComponent implements OnInit {
  ...
  listDetail() {
    ...
    this.reportApi.tihuodetcx(this.requestparams).then(data => {
