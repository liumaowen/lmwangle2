...
@Component({
  selector: 'app-wstihuodetreport',
  templateUrl: './wstihuodetreport.component.html',
  styleUrls: ['./wstihuodetreport.component.scss']
})
export class WstihuodetreportComponent implements OnInit {
  // 品名选择弹窗
    ...
    this.gridOptions.columnDefs = [
      ...
      },
      {
        ...
        children: [
          ...
          {
            cellStyle: { 'text-align': 'right' }, headerName: '采购成本单价', field: 'caigouchengben', minWidth: 100,
            valueFormatter: this.settings.valueFormatter2
          },
          {
  ...
  listDetail() {
    ...
    if (this.shitiend) {
      this.requestparams.shitiend = this.datepipe.transform(this.shitiend, 'y-MM-dd');
    }
    this.reportApi.wstihuodet(this.requestparams).then(data => {
