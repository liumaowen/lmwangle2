...
@Component({
  selector: 'app-cgbuchaimport',
  templateUrl: './cgbuchaimport.component.html',
  styleUrls: ['./cgbuchaimport.component.scss']
})
export class CgbuchaimportComponent implements OnInit {
