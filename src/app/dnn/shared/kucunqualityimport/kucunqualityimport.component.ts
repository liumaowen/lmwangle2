...
@Component({
  selector: 'app-kucunqualityimport',
  templateUrl: './kucunqualityimport.component.html',
  styleUrls: ['./kucunqualityimport.component.scss']
})
export class KucunqualityimportComponent implements OnInit {
  ...
  constructor(public bsModalRef: BsModalRef, public settings: SettingsService, private kucunapi: KucunService,
    ...
    private toast: ToasterService,private customerApi: CustomerapiService,private qualityApi: QualityobjectionService) {
  ...
  import() {
    ...
    const json = {qualityid: this.parentThis.qualityobjection.id, kucunids: ids};
    this.qualityApi.importkucun(json).then(data => {
